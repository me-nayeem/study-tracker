...
const CARD_COLORS = [
  { bg: "bg-accent-blue/15", border: "border-accent-blue/30", text: "text-accent-blue" },
  { bg: "bg-accent-purple/15", border: "border-accent-purple/30", text: "text-accent-purple" },
  { bg: "bg-accent-red/15", border: "border-accent-red/30", text: "text-accent-red" },
  { bg: "bg-accent-teal/15", border: "border-accent-teal/30", text: "text-accent-teal" },
  { bg: "bg-accent-gamify/15", border: "border-accent-gamify/30", text: "text-accent-gamify" },
];
    ...
    <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
      {topics.map((topic, i) => {
        ...
        return (
          ...
          >
            <p className={`text-sm font-medium ${colors.text}`}>{topic.name}</p>
